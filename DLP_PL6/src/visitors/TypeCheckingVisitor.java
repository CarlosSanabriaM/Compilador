...
public class TypeCheckingVisitor implements Visitor {
	 ...
	 */
	private void predicate(boolean predicate, ASTNode node, String errorMessage) {
		if( !predicate )
	...
	public Object visit(Assignment assignment, Object param) {
		...
		predicate(assignment.left.getLValue(), assignment, 
				"Semantical error: The left value of an assignment must be an lValue expression.");// TODO - semantical??
	...
	public Object visit(Read read, Object param) {
		...
		predicate(read.expression.getLValue(), read, 
				"Semantical error: Read statements must receive an lValue expression.");// TODO - semantical??
